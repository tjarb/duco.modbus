...
class IAV_RHValve{
	...
	static lib_url = "../../lib/IAV_RHValve.js";
...
*/
		...
		this.client 	= new IAV_RHValve.ModbusRTU();	
		console.log("initiated duco device: " + IAV_RHValve.name + "@" +this.duco_IPaddress+":"+this.duco_IPport+"->"+this.duco_modbusID+"["+this.duco_node +"]");
...
exports = module.exports = IAV_RHValve;