...
class RegValve{
	...
	static name = "Regular valve";


 	static lib_url = "../../lib/regvalve.js";
...
//        this._changedCurrent_L1 = self.homey.flow.getDeviceTriggerCard('changedCurrentL1');
		...
		this.client 	= new DucoValve.ModbusRTU();	
		console.log("initiated duco device: " + DucoValve.name + "@" +this.duco_IPaddress+":"+this.duco_IPport+"->"+this.duco_modbusID+"["+this.duco_node +"]");
...
exports = module.exports = RegValve;