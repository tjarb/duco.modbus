...
class CO2Valve{
	...
	static lib_url = "../../lib/co2valve.js";
...
*/
		...
		this.client 	= new CO2Valve.ModbusRTU();	
		console.log("initiated duco device: " + CO2Valve.name + "@" +this.duco_IPaddress+":"+this.duco_IPport+"->"+this.duco_modbusID+"["+this.duco_node +"]");
