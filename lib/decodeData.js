...
exports.decodeHexString = function (valueArr) {
  return Array.from(valueArr, function(byte) {
...
function decodeOperatingStatus(numType) {
    switch (numType) {
        ...
        case 569: return 'Activated'; break;
        case 1295: return 'Standby'; break;
...
function decodeBatteryOperationalStatusType(numType) {
    switch (numType) {
        case 303: return 'Off'; break;
        case 2291: return 'Standby'; break;
        case 2292: return 'Charge'; break;
        case 2293: return 'Discharge'; break;
        case 3664: return 'Emergency charge'; break;
        case 16777213: return 'Not available'; break;
        default: return `UNKNOWN (${numType})`; break;
    }
}
...
function decodeDeviceClass(numType) {
    switch (numType) {
        ...
        case 8009: return 'Hybrid inverter'; break;
...
function decodeDevice(typeId) {
    switch (typeId) {
        ...
        case 9488: return 'Sunny Tripower X 25'; break;
        case 19048: return 'STP 5.0-3SE-40'; break;
        case 19049: return 'STP 6.0-3SE-40'; break;
        case 19050: return 'STP 8.0-3SE-40'; break;
        case 19051: return 'STP 10.0-3SE-40'; break;
